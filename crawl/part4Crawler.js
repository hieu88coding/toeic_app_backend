...
puppeteer.launch({ headless: true, defaultViewport: null }).then(async browser => {
    ...
    // for (let i = 71; i < 99; i += 3) {
    //     const audioSrc = audioSrcs[(i - 71) / 3];
    ...
    //     const imageName = `test1_img_${95 + i * 3}_${97 + i * 3}.jpg`;
    ...
    await workbook.xlsx.writeFile('D:/ToeicApp/Exel/Test1/part4.xlsx');
    // Đóng trình duyệt
