...
puppeteer.launch({ headless: false }).then(async browser => {
    async function runMultipleTests(numTests) {
        for (let i = 1; i <= numTests; i++) {
            ...
            await page.goto(`https://estudyme.com/study/toeic-testpro/grammar/nouns/practice-${i}/`)
            ...
            await workbook.xlsx.writeFile(`D:/ToeicApp/answer/Grammar/Nouns_Test${i}_answer.xlsx`);
            ...
            //Save workbook to Excel file
            await newWorkbook.xlsx.writeFile(`D:/ToeicApp/Exel/Grammar/Nouns${i}_question.xlsx`);
        }
    }

    await runMultipleTests(7);
    await browser.close();
