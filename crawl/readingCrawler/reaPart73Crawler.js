...
puppeteer.launch({ headless: false }).then(async browser => {
    ...
    await page.goto('https://estudyme.com/study/toeic-testpro/part-7-triple-passages/test-10/')
    ...
    await workbook.xlsx.writeFile('D:/ToeicApp/answer/Part73/Part73_Test10_answer.xlsx');
    ...
    //Save workbook to Excel file
    await newWorkbook.xlsx.writeFile('D:/ToeicApp/Exel/Part73/Part73_Test10_question.xlsx');
