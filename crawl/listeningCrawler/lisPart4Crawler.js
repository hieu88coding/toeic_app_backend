...
puppeteer.launch({ headless: false }).then(async browser => {
    async function runMultipleTests(numTests) {
        for (let i = 3; i <= numTests; i++) {
            let audioFolderPath = `D:/ToeicApp/audio/Part4/Test${i}`;
            let page = await browser.newPage()
            let navigationPromise = page.waitForNavigation()
            await page.goto(`https://estudyme.com/study/toeic-testpro/part-4-short-talks/test-${i}/`)
            ...
            for (let i = 0; i < 10; i++) {
                ...
                let audioName = `part4_test${i}_audio_${i + 1}_${i + 3}.mp3`;
            ...
            // await workbook.xlsx.writeFile(`D:/ToeicApp/answer/Part4/Part4_Test${i}_answer.xlsx`);
            ...
            // //Save workbook to Excel file
            // await newWorkbook.xlsx.writeFile(`D:/ToeicApp/Exel/Part4/Part4_Test${i}_question.xlsx`);
        }
